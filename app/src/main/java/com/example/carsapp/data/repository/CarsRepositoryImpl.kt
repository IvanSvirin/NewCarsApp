...
import com.example.carsapp.domain.model.mapFromDto
...
class CarsRepositoryImpl @Inject constructor(private val database: CarsDatabase, private val carsApiService: CarsApiService) :
    CarsRepository {
